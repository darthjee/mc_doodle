...
function releaseLocal() {
  ...
  docker tag darthjee/mc_doodle:latest darthjee/mc_doodle:$VERSION
  docker push darthjee/mc_doodle:latest
  docker push darthjee/mc_doodle:$VERSION
}
...
case $ACTION in
  ...
  "signin")
    ...
    ;;
  "build")
    make PROJECT=production_mc_doodle build
    ;;
  "build-heroku")
    make build-heroku
    ;;
